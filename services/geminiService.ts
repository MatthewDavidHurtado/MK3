...
if (!apiKey || apiKey === 'YOUR_ACTUAL_GEMINI_API_KEY_HERE') {
    throw new Error("Please set your actual Gemini API key in the .env.local file. Replace 'YOUR_ACTUAL_GEMINI_API_KEY_HERE' with your real API key from Google AI Studio.");
}
